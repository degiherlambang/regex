...
import com.nusaregex.model.DAO.Function;
...
import com.nusaregex.controller.CValidator;
...
public class CManageAdmin {
    ...
    private final CValidator validator;
    ...
    public CManageAdmin(ViewManageAdmin vManageAdmin) {
        ...
        this.validator = CValidator.buildPasswordRule(false, false, true, 6, 12);
